...
- Entity key mismatch: `0`
- Duplicate rate: `0.0`
- Go p95 latency: `658.963 ms`
- Failed gate: `go_p95_latency_lt_300ms`
- Decision: keep Go in shadow mode; do not cut over until latency gate passes.
