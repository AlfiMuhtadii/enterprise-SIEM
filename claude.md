...
php artisan test         → 4724 passed, zero failures (dedicated detector_test DB; RefreshDatabase auto-migrates)
...
Threat hunting: replay-safe retrospective investigation across behavioral data, allowlisted bounded queries, advisory-only hunt records (append-only), no destructive operations. 181 supported domains.
...
AI agent reference (Codex/Cursor/Copilot): `AGENTS.md`
