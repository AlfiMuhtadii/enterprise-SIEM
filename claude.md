...
php artisan test         → 1111 passed, zero failures
...
Current: **1111 tests**, all green. Do NOT run parallel processes against the same PostgreSQL test database.
