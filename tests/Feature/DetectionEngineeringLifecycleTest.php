...
/**
 * Detection Engineering Lifecycle Phase 1 — Feature Tests.
 *
...
class DetectionEngineeringLifecycleTest extends TestCase
{
    ...
    // =========================================================================
    // Schema — new tables exist and are correctly structured
    // =========================================================================
    ...
    public function test_rule_hash_is_deterministic(): void
    {
        ...
        $this->assertEquals($hash1, $hash2, 'Rule hash must be deterministic — same inputs produce same hash');
    }
    ...
    public function test_create_suppression_starts_pending(): void
    {
        ...
        $this->assertFalse($supp->is_active, 'Suppression must start inactive — requires operator approval');
    }
    ...
    {
        // ATT&CK mappings are advisory metadata only — they must NOT automatically promote rules
        $this->assertFalse(
    ...
    {
        $this->assertCount(115, ThreatHuntingService::SUPPORTED_DOMAINS);
    }
    ...
    {
        // ACTIVE_ALLOWLIST must remain empty — defined in xdr_rule_registry_validate.py
        ...
        // The ACTIVE_ALLOWLIST must be empty — extract and verify
    ...
    public function test_rule_version_snapshots_are_never_destructively_mutated(): void
    {
        ...
        // Attempt to re-query — should be identical
