...
/**
 * Detection Engineering Lifecycle Phase 1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Feature Tests.
 *
...
class DetectionEngineeringLifecycleTest extends TestCase
{
    ...
    // =========================================================================
    // Schema ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â new tables exist and are correctly structured
    // =========================================================================
    ...
    // =========================================================================
    // Rule versioning ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â immutable snapshots
    // =========================================================================
    ...
    public function test_rule_hash_is_deterministic(): void
    {
        ...
        $this->assertEquals($hash1, $hash2, 'Rule hash must be deterministic ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â same inputs produce same hash');
    }
    ...
    public function test_create_suppression_starts_pending(): void
    {
        ...
        $this->assertFalse($supp->is_active, 'Suppression must start inactive ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â requires operator approval');
    }
    ...
    {
        // ATT&CK mappings are advisory metadata only ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they must NOT automatically promote rules
        $this->assertFalse(
    ...
    {
        $this->assertCount(177, ThreatHuntingService::SUPPORTED_DOMAINS);
    }
    ...
    {
        // ACTIVE_ALLOWLIST must remain empty ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â defined in xdr_rule_registry_validate.py
        ...
        // The ACTIVE_ALLOWLIST must be empty ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â extract and verify
    ...
    public function test_rule_version_snapshots_are_never_destructively_mutated(): void
    {
        ...
        // Attempt to re-query ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â should be identical
