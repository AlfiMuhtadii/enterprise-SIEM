...
/**
 * UEBA Phase 1 Ã¢â‚¬â€ Behavioral Baseline Analytics Tests.
 *
 * Asserts:
 ...
 *   - Replay-safe recalculation (same inputs Ã¢â€ â€™ same outputs)
...
class UEBABaselineAnalyticsTest extends TestCase
{
    ...
    public function test_compute_stats_is_deterministic(): void
    {
        ...
        // Deterministic: same data Ã¢â€ â€™ same result (delta handles DB float truncation)
    ...
    {
        // 4 observations Ã¢â‚¬â€ below MIN_SAMPLES_FOR_SCORING
    ...
    {
        // median=5, MAD=2, value=9 Ã¢â€ â€™ z = (9-5)/(1.4826*2) = 4/2.9652 Ã¢â€°Ë† 1.349
    ...
    public function test_percentile_rank_for_max_value_is_high(): void
    {
        ...
        $this->assertEquals(80.0, $rank); // 4 values below 5 Ã¢â€ â€™ 4/5 * 100 = 80
    }
    ...
    public function test_percentile_rank_for_min_value_is_zero(): void
    {
        ...
        $this->assertEquals(0.0, $rank); // 0 values below 1 Ã¢â€ â€™ 0%
    }
    ...
    public function test_percentile_rank_for_median_value_is_fifty(): void
    {
        ...
        $this->assertEquals(40.0, $rank); // 2 values below 3 Ã¢â€ â€™ 40%
    }
    ...
    {
        // [1,1,2,2,4,6,9] Ã¢â€ â€™ median=2, deviations=[1,1,0,0,2,4,7] Ã¢â€ â€™ MAD=median=1
    ...
    public function test_baseline_recalculation_is_replay_safe(): void
    {
        ...
        // Recalculate Ã¢â‚¬â€ same window, same data
        $baseline2 = $this->svc->computeBaseline('helen@test.com', 'user', 'saas_action_frequency');

        // Results must be identical (deterministic Ã¢â‚¬â€ delta handles DB float truncation)
        $this->assertEqualsWithDelta($baseline1->baseline_mean, $baseline2->baseline_mean, 1e-6);
        $this->assertEqualsWithDelta($baseline1->baseline_median, $baseline2->baseline_median, 1e-6);
    ...
    public function test_observations_are_append_only(): void
    {
        ...
        $this->assertEquals($countBefore + 1, $countAfter,
            'Each recordObservation call should INSERT a new row Ã¢â‚¬â€ never update');
    }
    ...
    public function test_anomaly_scores_are_append_only(): void
    {
        ...
        $this->assertEquals($countBefore + 2, $countAfter,
            'Each scoreAnomaly call should INSERT a new row Ã¢â‚¬â€ never update');
    }

    // =========================================================================
    // Risk factor integration Ã¢â‚¬â€ advisory only
    // =========================================================================
    ...
    public function test_every_anomaly_score_has_is_advisory_true(): void
    {
        ...
        $this->assertTrue($score->is_advisory,
            'Every anomaly score MUST have is_advisory=true Ã¢â‚¬â€ UEBA never triggers enforcement');
    }
    ...
    // =========================================================================
    // Advisory-only enforcement Ã¢â‚¬â€ hard safety assertions
    // =========================================================================
    ...
    // =========================================================================
    // API endpoints Ã¢â‚¬â€ advisory response assertions
    // =========================================================================
    ...
    // =========================================================================
    // UI routes Ã¢â‚¬â€ accessible and display advisory disclaimer
    // =========================================================================
    ...
    public function test_ueba_rules_are_never_staged_active(): void
    {
        ...
        $this->assertEmpty($uebaActive,
            'No UEBA rules may ever be staged_active Ã¢â‚¬â€ they require a domain-specific 6h soak PASS');
    }
