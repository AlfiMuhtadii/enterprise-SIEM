...
class TelemetryScalePilotTest extends TestCase
{
    ...
    {
        $this->assertFalse(method_exists(TelemetryScalePilotService::class, 'isolateHost'));
    }

    public function test_no_quarantine_host_method(): void
    {
        $this->assertFalse(method_exists(TelemetryScalePilotService::class, 'quarantineHost'));
    }

    public function test_no_execute_shell_method(): void
    {
        $this->assertFalse(method_exists(TelemetryScalePilotService::class, 'executeShell'));
    }

    public function test_no_kill_process_method(): void
    {
        $this->assertFalse(method_exists(TelemetryScalePilotService::class, 'killProcess'));
    }

    public function test_no_auto_remediate_method(): void
    {
        $this->assertFalse(method_exists(TelemetryScalePilotService::class, 'autoRemediate'));
    }
    ...
    public function test_threat_hunting_has_110_supported_domains(): void
    {
        $this->assertCount(120, app(ThreatHuntingService::class)->supportedDomains());
    }
