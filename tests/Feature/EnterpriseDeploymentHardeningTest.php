...
class EnterpriseDeploymentHardeningTest extends TestCase
{
    ...
    {
        $this->assertFalse(method_exists(EnterpriseDeploymentHardeningService::class, 'isolateHost'));
    }

    public function test_no_quarantine_host_method(): void
    {
        $this->assertFalse(method_exists(EnterpriseDeploymentHardeningService::class, 'quarantineHost'));
    }

    public function test_no_execute_shell_method(): void
    {
        $this->assertFalse(method_exists(EnterpriseDeploymentHardeningService::class, 'executeShell'));
    }

    public function test_no_kill_process_method(): void
    {
        $this->assertFalse(method_exists(EnterpriseDeploymentHardeningService::class, 'killProcess'));
    }

    public function test_no_auto_remediate_method(): void
    {
        $this->assertFalse(method_exists(EnterpriseDeploymentHardeningService::class, 'autoRemediate'));
    }
