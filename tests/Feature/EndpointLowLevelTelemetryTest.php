...
/**
 * Endpoint Low-Level Telemetry Phase 1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Feature Tests.
 *
...
class EndpointLowLevelTelemetryTest extends TestCase
{
    ...
    // =========================================================================
    // Append-only guarantees ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no updated_at
    // =========================================================================
    ...
    // =========================================================================
    // Risk engine ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â new factors
    // =========================================================================
    ...
    // =========================================================================
    // HARD SAFETY INVARIANTS ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â these must NEVER be removed or loosened
    // =========================================================================
    ...
    public function test_privilege_escalation_records_cannot_be_deleted(): void
    {
        ...
        $id = $esc->id;
        // Attempt to delete should not be done from service ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â table is append-only
