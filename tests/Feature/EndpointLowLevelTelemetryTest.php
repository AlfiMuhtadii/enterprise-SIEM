...
/**
 * Endpoint Low-Level Telemetry Phase 1 Ã¢â‚¬â€ Feature Tests.
 *
...
class EndpointLowLevelTelemetryTest extends TestCase
{
    ...
    // =========================================================================
    // Append-only guarantees Ã¢â‚¬â€ no updated_at
    // =========================================================================
    ...
    // =========================================================================
    // HARD SAFETY INVARIANTS Ã¢â‚¬â€ these must NEVER be removed or loosened
    // =========================================================================
    ...
    public function test_privilege_escalation_records_cannot_be_deleted(): void
    {
        ...
        $id = $esc->id;
        // Attempt to delete should not be done from service Ã¢â‚¬â€ table is append-only
