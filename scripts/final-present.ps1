...
Write-Host "- docs/guides/README_phase12_mlops.md"
Write-Host "- docs/guides/README_phase13_threat_model.md"
Write-Host "- docs/guides/README_phase14_response.md"
Write-Host ""
Write-Host "Full demo guide: note.md"
