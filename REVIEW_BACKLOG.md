...
| **TENANT-HUNT-CORRELATION-ISOLATION** | [Security] Add tenant isolation to threat hunt query correlations and saved sessions. | `app/Http/Controllers/SocHuntController.php` | High | Ongoing (Codex, 2026-08-28) |
...
## Proposed Task: TENANT-HUNT-CORRELATION-ISOLATION — Harden Threat Hunt Correlation Scoping

- **Work status:** Ongoing (Codex, 2026-08-28); auditing controller queries and existing tenant-boundary conventions before implementation.
- **Priority:** High
