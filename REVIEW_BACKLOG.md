...
| **HUNT-TENANCY-GAP (verification takeover)** | Finish and validate the uncommitted tenant-lineage/scoping implementation for threat hunts, queries, result snapshots, pivots, and API/web access. | `ThreatHuntingService`, threat-hunt controllers/models/migration/tests | High | Ongoing (Codex, 2026-08-29) |
