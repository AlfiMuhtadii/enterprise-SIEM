...
- **Status:** Ongoing (Codex, 2026-08-28) - adding fail-closed PostgreSQL TLS environment validation after the completed Laravel DSN wiring; server-side TLS remains separate.
>
