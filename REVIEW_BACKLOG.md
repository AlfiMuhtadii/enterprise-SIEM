...
| **TENANT-ENDPOINT-HEARTBEAT-ISOLATION** | Add tenant lineage and tenant-scoped reads for append-only endpoint heartbeats, closing the remaining endpoint telemetry gap before RLS activation. | `endpoint_agent_heartbeats`, heartbeat ingestion/read paths | High | Ongoing (Codex, 2026-08-29) |
