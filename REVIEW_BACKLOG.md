...
| **TENANT-FORENSIC-ISOLATION** | [Security] Add tenant isolation to forensic collection requests and audit building. | `app/Http/Controllers/SocForensicController.php` | High | Ongoing (Codex, 2026-08-28) |
...
## Proposed Task: TENANT-FORENSIC-ISOLATION — Scope Forensic Requests and Build Scoped Artifacts

- **Work status:** Ongoing (Codex, 2026-08-28); verifying the existing `93b85e8` implementation against this candidate's validation gate.
- **Priority:** High
