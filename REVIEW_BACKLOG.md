...
| Task ID | Title | File / Component | Priority | Status |
|---|---|---|---|---|
| **ENT-SEC-NO-TLS-INTERNAL** (phase 42 ongoing - demo-alert Pandaproxy TLS) | [Enterprise BLOCKER - reduced] Add explicit private-CA and hostname verification to the deterministic demo-alert Pandaproxy publisher without changing its local plaintext default. | `scripts/xdr_send_demo_alert.py`, `tests/scripts/test_xdr_send_demo_alert.py`, `docs/operations/PANDAPROXY_BOOTSTRAP_TLS.md` | High | Ongoing |
