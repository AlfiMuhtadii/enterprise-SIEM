...
**Expected:** `4544 passed` — zero failures, zero skipped.
Last full verification: 4544 PHP (2026-06-30, after the alert/agent N+1 batches, TZ-AGENT-STALE fix, AI-context enrichment, and IOC/status refinements).
